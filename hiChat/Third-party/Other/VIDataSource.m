...
//  VICoreDataSource
//
//  Created by zhangliyong on 16/12/12.
//  Copyright © 2016年 zhangliyong. All rights reserved.
//
...
- (instancetype)initWithManagedObjectContext:(NSManagedObjectContext *)managedContex coordinator:(NSPersistentStoreCoordinator *)coordinator {
    if (self = [self init]) {
        ...
        NSString *string = [NSString stringWithFormat:@"com.zhangliyong.%@.queue", NSStringFromClass([self class])];
